package livingrobots.ev3.ch7.motionDetection;
...
public class MotionDetectorServer extends WebSocketServer {

	public MotionDetectorServer( int port ) throws UnknownHostException{
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		int port = 20000;
		MotionDetectorServer s = new MotionDetectorServer(port);
		s.start();
